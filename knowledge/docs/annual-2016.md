---
source: https://www.dol.gov/general/foia/reports/annual/2016
scraped_at: 2025-12-26T02:25:08.221308
...
# U.S. Department of Labor Freedom of Information Act Annual Report for Fiscal Year 2016 | U.S. Department of Labor

**Note:** [Download the Tables as Extensible Markup Language (XML) file format.](/sites/dolgov/files/general/foia/reports/DOL-FY16-Final.xml "Download the Tables as Extensible Markup Language (XML) file format")
[Download the Tables as Excel Microsoft Office Format Spreadsheet (XLSX) file format.](/sites/dolgov/files/general/foia/reports/FOIA_Raw_Data.xlsx "Download the Tables as Excel Microsoft Office Format Spreadsheet  (XLSX) file format")
[Download the FY2016 Exclusions and (a)(2) Postings.](/sites/dolgov/files/general/foia/reports/DOL-FY2016-ANNUAL-FOIA-REPORT-RAW-DATA-EXCLUSIONS-WEB-PUBS.csv "Download the FY2016 Exclusions and (a)(2) Postings")
...
Although FOIA processes at DOL are decentralized, departmental oversight is provided by the Office of Information Services (OIS), which operates under the supervision of the Solicitor of Labor, the Department's Chief FOIA Officer. OIS provides agency-wide leadership and guidance to ensure compliance with FOIA, particularly to increase the quality and timeliness of FOIA responses; reduce the backlog of pending FOIA requests; and review the effectiveness of each agency's FOIA processes in order to benchmark best practices, and make recommendations for programmatic improvements. The Department is also revising its FOIA regulation to ensure compliance with the amended statute.
During FY2016, the Department received a total of **16,196** initial requests and processed 16,466 requests. Additional information about the Department's FOIA program is available online at [https://www.dol.gov/general/foia](/general/foia).
...
During fiscal year 2016, as part of DOL's continuing review of SIMS-FOIA data, DOL identified 260 FOIA requests that were received during FY2015 but that were not placed into active processing and tracking status until after the end of fiscal year 2015. This means that the 1,303 FOIA requests that the FY2015 DOL Annual FOIA report reported as pending at the end of FY2015 must be increased by 260 requests, and so that the chart in this section reports that DOL had 1,563 requests pending at the start of FY2016.
...
Due to a system limitation, the charts in this section may contain information about unperfected requests.
C I. Processed Simple Requests - Response Time in Day Increments
Due to a system limitation, the charts in this section may contain information about unperfected requests.
C II. Processed Complex Requests - Response Time in Day Increments
Due to a system limitation, the charts in this section may contain information about unperfected requests.
C III. Processed Requests Granted Expedited Processing - Response Time in Day Increments
Due to a system limitation, the charts in this section may contain information about unperfected requests.
...
As a part of reviewing data in the Departmental FOIA tracking system, DOL located 260 initial FOIA requests that remained pending in the system as of the end of FY2015 and requiring further action, many of which were received in prior years. Whereas DOL's FY2015 report identified the 10 oldest pending requests it believed to be pending at the end of FY2014, with addition of the additional 260 FOIA requests identified as part of the data review, DOL has identified and this chart includes 1 request that should have been previously reported as among the 10 oldest pending requests.
...
XI. FOIA REGULATIONS
A. Number of Times Subsections (C) Used
...
After reviewing its databases, OLMS and WHD updated the number of consultations pending at the start of the Fiscal Year.
C. Consultations on FOIA Requests - Ten Oldest Consultations Received from Other Agencies and Pending at Your Agency
D (1). Comparison of Number of Requests from Previous and Current Annual Report - Requests Received, Processed, and Backlogged
D (2). Comparison of Numbers of Requests from Previous and Current Annual Report -- Backlogged Request
...
E (2). Comparison of Numbers of Administrative Appeals from Previous and Current Annual Report -- Backlogged Appeals
