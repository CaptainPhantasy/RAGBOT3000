---
source: https://www.dol.gov/general/foia/reports/annual/2021
scraped_at: 2025-12-26T02:25:22.571602
...
# U.S. Department of Labor Freedom of Information Act Annual Report for Fiscal Year 2021 | U.S. Department of Labor

**Note:** [[Download the Tables as Extensible Markup Language (XML) file format.]](/sites/dolgov/files/general/foia/reports/DOLFY21.xml "Download the Tables as Extensible Markup Language (XML) file format")
[[Download the Tables as Excel Microsoft Office Format Spreadsheet (XLSX) file format.]](/sites/dolgov/files/general/foia/reports/FOIA_Raw_Data_FY2021.xlsx "Download the Tables as Excel Microsoft Office Format Spreadsheet  (XLSX) file format")
...
Although FOIA processes at DOL are decentralized, departmental oversight is provided by the Office of Information Services (OIS), which operates under the supervision of the Solicitor of Labor, the Department's Chief FOIA Officer. OIS provides agency-wide leadership and guidance to ensure compliance with FOIA, particularly to increase the quality and timeliness of FOIA responses; reduce the backlog of pending FOIA requests; and review the effectiveness of each agency's FOIA processes to benchmark best practices and make recommendations for programmatic improvements.
As reported last year, the Department launched its new tracking system, FOIAXpress, for all DOL components (except OIG) on October 1, 2020. Shortly thereafter, legacy data was migrated to FOIAXpress, making it the sole source of all FOIA related data except for OIG data and Section IX FOIA personnel and costs. During this reporting period, DOL worked to master the system functionality of FOIAXpress and to map issues to ensure that parent-child relationships were clearly established to promote more accurate reporting within the system. During this fiscal year, DOL modified FOIAXpress to account for the relocation of three action offices that were established to monitor the tracking of FOIA requests that had been consolidated or coordinated for processing purposes and identify FOIA requests that were orphaned due to migration issues and FOIA requests in the OIS processing queue awaiting assignment or clarification. We also learned that we had not properly locked our FY 2020 Annual Report Data, which allowed some requests to be acted upon after the end of the fiscal year. To the extent that these issues have impacted data previously reported, we have annotated this report with footnotes.
During FY 2021, the Department received a total of **13,560** initial requests and processed **14,022** requests. Additional information about the Department's FOIA program is available online at [https://www.dol.gov/general/foia](/general/foia).
...
B. The electronic address for this report is [http://www.dol.gov/dol/foia/main.htm](/general/foia).
...
The Department is organized into divisions and agencies often referred to as components. Each component processes its own FOIA requests. Therefore, a request will receive the fastest possible response if it is addressed directly to the disclosure officer for the component that a requester believes has the records.
The DOL "Guide to Submitting a Request Under FOIA" provides general information about the FOIA program at DOL as well as basic information on how to submit a FOIA request. The Guide also contains links to the DOL agency components in both the national and regional offices, a brief description of expected response times, and reasons why some requests cannot be granted by DOL. This Guide is available on DOL's website at [http://www.dol.gov/dol/foia/guide6.htm](/general/foia/guide).
...
*DOL has adjusted the number of requests pending as of the start of FY 2021 for the following components: EBSA, MSHA, ODEP, OLMS, OPA, OSHA, OWCP, SOL, and WHD.*
...
*After reviewing their databases, the following components updated the number of appeals pending at the start of the Fiscal Year: Adj Bds, EBSA, ETA, MSHA, OALJ, OFCCP, OSHA, SOL, VETS, and WHD.*
...
*Charts VII.A. – VII.E. contain data about both perfected and non-perfected FOIA requests. In the next fiscal year DOL will work to ensure that our FOIA tracking system is able to identify and distinguish request types so that the charts in this section only report data related to perfected requests.*
