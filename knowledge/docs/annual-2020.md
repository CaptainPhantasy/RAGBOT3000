---
source: https://www.dol.gov/general/foia/reports/annual/2020
scraped_at: 2025-12-26T02:25:24.587414
...
# U.S. Department of Labor Freedom of Information Act Annual Report for Fiscal Year 2020 | U.S. Department of Labor

**Note:** [[Download the Tables as Extensible Markup Language (XML) file format.]](/sites/dolgov/files/general/foia/reports/DOLFY20.xml "Download the Tables as Extensible Markup Language (XML) file format")
[[Download the Tables as Excel Microsoft Office Format Spreadsheet (XLSX) file format.]](/sites/dolgov/files/general/foia/reports/FOIA_Raw_Data_FY2020.xls "Download the Tables as Excel Microsoft Office Format Spreadsheet  (XLSX) file format")
...
For the past two years, the Department has been evaluating processes and protocols to implement changes aimed at improving the effectiveness of the overall FOIA program. As part of this process, we determined that we needed to leverage technology to modernize this task. Since 2006, the Department had been using the Secretary's Information Management System for FOIA (SIMS-FOIA) to track and manage FOIA requests. SIMS-FOIA also served as the central data source for all of the Department's mandated reporting, including the annual FOIA report. After a year of concentrated effort in this area, the Department launched FOIAXpress for all DOL components (except OIG) on October 1, 2020. Shortly thereafter, legacy data was migrated from SIMS-FOIA to FOIAXpress, making the new system the sole source of all FOIA related data.
As a result of the data migration, we identified some anomalies related to 685 FOIA requests that were not counted previously for a number of reasons: 1) FOIA cases that were received and logged into SIMS-FOIA but were not coded appropriately, so they were not counted in previous iterations of our data reporting; 2) FOIA cases that were previously assigned to DOL agency components that no longer exist due to reorganizations (at the Department or component level) and those cases were not moved into the active processing queues of the newly designated components or offices; 3) FOIA cases assigned to system users that have separated from the organization and were not transferred to an active system user; and, 4) FOIA assignments that were duplicative and the duplicate request was left unresolved. This report reconciles those discrepancies with footnotes where appropriate.
During FY2020, the Department received a total of **15,820** initial requests and processed **15,645** requests. Additional information about the Department's FOIA program is available online at [https://www.dol.gov/general/foia](/general/foia).
...
2. The electronic address for this report is [https://www.dol.gov/general/foia](/general/foia).
...
*During Fiscal Year (FY) 2020, DOL migrated legacy data into a new case management system. Through this migration, DOL identified various discrepancies in data previously reported. As a result, the 1,729 FOIA requests that the FY 2019 DOL Annual FOIA Report indicated as pending at the end of the fiscal year must be increased to 2,414 requests pending at the start of FY 2020. After reviewing its data, DOL has adjusted the number of requests pending as of the start of FY 2020 for the following components: ADJ BDS, BLS, EBSA, ETA, ILAB, MSHA, OALJ, OASAM, OCFO, OCIA, ODEP, OFCCP, OLMS, OPA, OSEC, OSHA, SOL, VETS, WB, and WHD.*
...
*After reviewing their databases, the following components updated the number of appeals pending as of the start of the Fiscal Year: Adj Bds, EBSA, ETA, MSHA, OALJ, OFCCP, OSHA, VETS, and WHD.*
...
*As reported in Section V.A, DOL migrated legacy data into a new case management system. Through this migration, DOL identified various discrepancies in data previously reported. Accordingly, the number of requests received from last year's Annual Report has been revised from 16,090 to 16,259, and the number of processed requests from last year's Annual Report has been revised from 16,350 to 16,438.*
