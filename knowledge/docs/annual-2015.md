---
source: https://www.dol.gov/general/foia/reports/annual/2015
scraped_at: 2025-12-26T02:25:07.736252
...
# U.S. Department of Labor Freedom of Information Act Annual Report for Fiscal Year 2015 | U.S. Department of Labor

**Note:** [Download the Tables as Extensible Markup Language (XML) file format.](/sites/dolgov/files/general/foia/reports/FOIA-FY2015.xml "Download the Tables as Extensible Markup Language (XML) file format")
...
The Department received a total of 16,792 initial requests for records during Fiscal Year 2015, a 4% increase from the 16,106 requests received in FY2014. See Table V(A) in the FY2014 and FY2015 Reports. During FY2015, the Department processed 17,104 initial FOIA requests which represented increased processing of 389 requests (or a 2% increase) from the 16,715 requests processed in FY2014. Id. Because the increase in processed requests was smaller than the increase in incoming requests, at year’s end, total requests in “backlog” status (meaning not processed within statutory time limits) had increased from 561 at the end of FY2014 to 593 at the end of FY2015. See Table XII(A) in the FY2014 and FY2015 Reports. Additional information about the Department’s FOIA program is available online at [https://www.dol.gov/general/foia](/general/foia).
...
V. A. FOIA REQUESTS
|
As noted in the Executive Summary, during fiscal year 2015, as part of DOL's continuing review of SIMS-FOIA data, DOL identified 428 FOIA requests that were received during FY2014 but that were not placed into active processing and tracking status until after the end of fiscal year 2014. This means that the 1,187 FOIA requests that the FY2014 DOL Annual FOIA report reported as pending at the end of FY2014 must be increased by 428 requests, and so the chart above reports that DOL had 1,615 requests pending at the start of FY2015.
...
Due to a system limitation, the charts in this section may contain information about unperfected requests.  
Some work day ranges reported appear to be out of sequence based on the date of the receipt of the request. However, this is attributed to requests that have been tolled for clarification or to resolve fee matters consistent with the provisions of the statute.  
As a part of reviewing data in the Departmental FOIA tracking system, DOL located 428 initial FOIA requests that remained pending in the system as of the end of FY2014 and requiring further action, many of which were received in prior years. Whereas DOL's FY2014 report identified the 10 oldest pending requests it believed to be pending at the end of FY2013, with addition of the additional 428 FOIA requests identified as part of the data review, DOL has identified and this chart includes 2 requests that should have been previously reported as among the 10 oldest pending requests.
...
DOL experienced an increase from 561 backlogged initial FOIA requests pending at the end of FY2014, up to 593 backlogged pending as of the end of FY2015. This is attributed, in part, to the addition of 428 pending requests that had not, but should have, been included in the FY2014 Annual FOIA report as discussed in the Executive Summary. DOL's FOIA staff will continue to work toward more consistent use of the Department's FOIA tracking system and a sustained effort toward backlog reduction throughout the Department's 23 FOIA components.  
DOL experienced an increase from 316 backlogged administrative appeals pending at the end of FY2014, up to 405 backlogged pending as of the end of FY2015. While the Department completed more FOIA appeals in FY2015 than in FY2014 (297 this year, vs. 277 in FY2014), the backlog nonetheless rose due to the continuing high number of incoming FOIA appeals, the complexity of some appeal requests, and the limited number of staff available to address FOIA appeals.
B. Consultations on FOIA Requests - Received, Processed, and Pending Consultations
As a part of the review of data in Departmental FOIA tracking system, DOL located 428 requests that remained pending in the system and requiring further action, many of which were received in prior years. Among those are five additional consultations originating with OSHA and one additional consultation originating with WHD, which should have been previously reported.
C. Consultations on FOIA Requests - Ten Oldest Consultations Received from Other Agencies and Pending at Your Agency
D. Comparison of Number of Requests from Previous and Current Annual Report - Requests Received, Processed, and Backlogged
E. Comparison of Numbers of Administrative Appeals from Previous and Current Annual Report - Appeals Received and Processed
