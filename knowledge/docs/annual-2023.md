---
source: https://www.dol.gov/general/foia/reports/annual/2023
scraped_at: 2025-12-26T02:25:23.999282
...
# U.S. Department of Labor Freedom of Information Act Annual Report for Fiscal Year 2023 | U.S. Department of Labor

**Note:** [[Download the Tables as Extensible Markup Language (XML) file format.]](/sites/dolgov/files/general/foia/reports/DOLFY23.xml "Download the Tables as Extensible Markup Language (XML) file format")
[[Download the Tables as Excel Microsoft Office Format Spreadsheet (XLSX) file format.]](/sites/dolgov/files/general/foia/reports/FOIA_Raw_Data_FY2023.xlsx "Download the Tables as Excel Microsoft Office Format Spreadsheet  (XLSX) file format")
...
During FY 2023, the Department received a total of **14,282** initial requests and processed **14,219** requests. Additional information about the Department's FOIA program is available online at [https://www.dol.gov/general/foia](/general/foia).
...
2. The electronic address for this report is [http://www.dol.gov/dol/foia/main.htm](/general/foia).
...
15. Bureau of Labor Statistics (BLS), (202) 691-7628.
16. Employment and Training Administration (ETA), (202) 693-3140.
17. Mine Safety and Health Administration (MSHA), (202) 693-9440.
...
2. Why some requests are not granted.
...
3. The department of labor's FOIA regulations can be found online at: <https://www.ecfr.gov/current/title-29/subtitle-A/part-70>.
**III.  Definitions. Exemptions and Acronyms**
...
*After reviewing its database, DOL updated the number of requests pending at the start of the Fiscal Year for the following components: Adj Bds, OSEC, OSHA, SOL, OIG.*
...
*After reviewing its database, DOL updated the number of appeals pending at the start of the Fiscal Year for the following components: OIG, SOL.*
