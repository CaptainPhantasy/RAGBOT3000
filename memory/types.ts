interface WebObservation {
  ...
  content_analysis: {
    text_content: {
      headings_structure: Array<{ level: number; text: string; position: string }>;
      paragraphs: Array<{ length: number; readability_score: number; position: string }>;
  ...
  accessibility: {
    ...
    visual_accessibility: {
      color_contrast: Array<{ element: string; ratio: number; passes: boolean }>;
      text_scaling: string[];
